...
import { Plus, Search, Edit, Trash2, MapPin, Eye, Users, Loader2 } from 'lucide-react'
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1">Add, edit, and manage destination information</p>
          </div>
          <button
            onClick={() => setIsModalOpen(true)}
            className="bg-primary-600 hover:bg-primary-700 text-white font-semibold px-6 py-3 rounded-lg flex items-center gap-2 transition shadow-lg hover:shadow-xl"
          >
            <Plus size={20} />
            Add Destination
          </button>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredDestinations.map((dest) => {
                const categoryLabel = categoryLabels[dest.category] || dest.category
                return (
                  <div key={dest.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-sm text-gray-600 mb-4 line-clamp-2">{dest.description || 'No description'}</p>
